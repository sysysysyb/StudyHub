  ...
  results: [
    {
      ...
      applicant: {
        ...
        goal: '수료 후에는 팀 내 프론트엔드 아키텍처 개선 프로젝트를 주도하는 것이 목표입니다.',
        available_time:
          '평일 저녁 7시 이후와 주말 오후 시간을 활용할 수 있습니다.',
    ...
    },
    {
      ...
      applicant: {
        ...
        goal: '효율적인 데이터베이스 구조 설계와 안정적인 API 서버 개발을 목표로 합니다.',
    ...
    },
    {
      ...
      applicant: {
        ...
        goal: '머신러닝 모델을 직접 구현하고, 데이터 분석 업무에 적용하는 것이 목표입니다.',
        available_time:
    ...
    },
    {
      ...
      applicant: {
        ...
        goal: 'AWS 기반 CI/CD 파이프라인을 구축하여 안정적인 서비스 배포를 실현하는 것이 목표입니다.',
        available_time:
    ...
    },
    {
      ...
      applicant: {
        ...
        goal: '프론트엔드와 디자인의 접점에서 더 나은 사용자 경험을 제공하는 것이 목표입니다.',
        available_time:
